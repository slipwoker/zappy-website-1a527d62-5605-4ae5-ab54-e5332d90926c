                ...
                fetch(action, options)
                    .then(function(response) {
                        if (response.ok) {
                            ...
                            successMessage.style.cssText = 'color: #38a169; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background: #f0fff4; border-radius: 0.25rem;';
                    ...
                    .catch(function() {
                        ...
                        errorMessage.style.cssText = 'color: #e53e3e; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background: #fff5f5; border-radius: 0.25rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1a527d62-5605-4ae5-ab54-e5332d90926c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1a527d62-5605-4ae5-ab54-e5332d90926c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1a527d62-5605-4ae5-ab54-e5332d90926c';
